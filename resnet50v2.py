...
from keras.applications import ResNet50V2  # Correct import

# Constants
image_size = (240, 240)  # ResNet50V2 expects input size of (240, 240)
batch_size = 32
epochs = 10
...
# Model
base_model = ResNet50V2(input_shape=(240, 240, 3), include_top=False, weights='imagenet')
